...
A **Fedora 39** programming station.
...
Fedora 39 reached end of life in November 2024. The container still builds, because Fedora keeps its released container
...
```bash
fedora39/run-docker-station 'gcc --version'
fedora39/run-docker-station bash
```
